...
request.onload = function () {
  ...
  if (request.status >= 200 && request.status < 400) {
    for (var i = 0; i < data.drinks.length; i++) {
      ...
      app2.innerHTML += "<b>Drink Name :</b> " + data.drinks[i]["strDrink"] + "<br><br> <b>Drink Type : </b>" + data.drinks[i]["strAlcoholic"] + "<br><br> <b>Glass Type : </b> " + data.drinks[i]["strGlass"]  + "<br><br> <b>Ingredients :</b> " + data.drinks[i]["strIngredient1"] + "<br><br> <b>Instructions :</b> " + data.drinks[i]["strInstructions"] + ", " + data.drinks[i]["strIngredient2"] + ", " + data.drinks[i]["strIngredient3"] + data.drinks[i]["strIngredient4"] + data.drinks[i]["strIngredient5"] + data.drinks[i]["strIngredient6"] + "<br><br> <b>Measures : </b>" + data.drinks[i]["strMeasure1"] + ", " + data.drinks[i]["strMeasure2"] + ", " + data.drinks[i]["strMeasure3"] + data.drinks[i]["strMeasure4"] + data.drinks[i]["strMeasure5"];
